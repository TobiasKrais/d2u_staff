...
$sql->setQuery("CREATE TABLE IF NOT EXISTS `". rex::getTablePrefix() ."d2u_staff_lang` (
    ...
    `area_of_responsibility` varchar(255) collate utf8_general_ci default NULL,
    `position` varchar(255) collate utf8_general_ci default NULL,
    `citation` text collate utf8_general_ci default NULL,
	`translation_needs_update` varchar(6) collate utf8_general_ci default NULL,
    `updatedate` int(11) default NULL,
