...
echo '<div class="row align-items-stretch g-4">';
foreach ($stafflist as $staff) {
    echo '<div class="col-12 col-md-6 module-box-wrapper-mod-22-1 d-flex">';
    echo '<div class="module-box-mod-22-1 flex-fill">';
